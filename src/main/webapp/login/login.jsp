...
<head>
    ...
    <script>
        ...
        function changeCode() {
            $("#captchaImage").attr("src", "${app}/code/getCode?time=" + new Date().getTime());
        }
    </script>
</head>
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 48px" onclick="changeCode()" class="captchaImage"
                                     src="${app}/code/getCode">
                                <input style="width: 260px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
